...
{
    public partial class Komik_Form : Form
    {
        ...
        {
            string queryDashboard = "SELECT `judulBuku`, `penulis`, `genre`, `penerbit`, `sinopsis` FROM `tb_tambahbuku` WHERE `genre`='Komik' ";
            ...
            try
            {
                ...
                dataGridView_Komik.DataSource = dtDashboard;
            }
            catch (Exception ex)
            {
