...
{
    public partial class HdP_Form : Form
    {
        ...
        private void LoadDataHdP()
        {
            string queryDashboard = "SELECT `judulBuku`, `penulis`, `genre`, `penerbit`, `sinopsis` FROM `tb_tambahbuku` WHERE `genre`='Hukum dan Politik' ";
            ...
            try
            {
                ...
                dataGridView_HdP.DataSource = dtDashboard;
            }
            catch (Exception ex)
            {
